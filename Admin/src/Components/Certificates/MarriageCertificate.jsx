...
export default function MarriageCertificate() {
  ...
  // ✅ YOUR BACKEND ROUTE
  const API = "http://localhost:5000/api/marriage-form";
  ...
  if (loading) {
    return <p className="text-center mt-10 text-lg">Loading marriage certificates...</p>;
  }
        ...
        <table className="min-w-full bg-white shadow-md rounded-lg">
          ...
          <thead className="bg-gray-200 text-gray-700 text-xs lg:text-sm">
            <tr>
              ...
              <th className="px-3 py-2">Wife</th>
              <th className="px-3 py-2">Husband Aadhar</th>
              <th className="px-3 py-2">Wife Aadhar</th>
              <th className="px-3 py-2">Mobile</th>
              <th className="px-3 py-2">Email</th>
              <th className="px-3 py-2">Year</th>
              <th className="px-3 py-2">Marriage Date</th>
          ...
          <tbody>
            {data.map((item) => (
              <tr key={item._id} className="border-t text-xs lg:text-sm hover:bg-gray-50">
                ...
                <td className="px-3 py-2">{item.husbandName}</td>
                <td className="px-3 py-2">{item.wifeName}</td>

                <td className="px-3 py-2">{item.husbandAadhar}</td>
                <td className="px-3 py-2">{item.wifeAadhar}</td>
                ...
                <td className="px-3 py-2">
                  {new Date(item.marriageDate).toLocaleDateString()}
                </td>

                <td className="px-3 py-2">{item.marriagePlace}</td>
