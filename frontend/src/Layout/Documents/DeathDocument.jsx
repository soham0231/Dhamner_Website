  ...
  return (
    <div className="w-full">
      ...
      <div className="max-w-4xl mx-auto p-4 text-gray-700 text-center">
        <p>
          आपण मृत्यू प्रमाणपत्रासाठी खाली दिलेल्या ऑनलाइन फॉर्म मध्ये अर्ज करू शकता.
          कृपया आधी ₹20/- फी QR कोड स्कॅन करून भरा व त्याचा स्क्रीनशॉट ठेवा.
      ...
      >
        ...
        <div className="text-center space-y-4">
          ...
          <p className="font-semibold">
            ₹20 शुल्क भरल्यानंतर UTR नंबर टाका
          </p>
